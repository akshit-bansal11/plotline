...
export function EntryDetailModal({
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title="Item details"
      className="max-h-150 bg-neutral-900/60"
    ...
    >
      ...
      >
        <div className="relative flex flex-col gap-6 sm:flex-row p-4 min-h-75">
          {entry.status !== "unspecified" ? (
            <div className="absolute right-0 top-0" ref={statusMenuRef}>
              <button
                type="button"
          ...
          <div className="flex-1 space-y-4">
            ...
            {entry.description ? (
              <div className="text-sm text-neutral-300 whitespace-pre-line">
                {entry.description}
              </div>
            ) : null}
            {entry.genresThemes.length > 0 ? (
              <div className="flex flex-wrap gap-2">
                {entry.genresThemes.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-white/10 bg-neutral-800/50 px-2 py-1 text-xs text-neutral-200"
                  >
                    {tag}
                  </span>
                ))}
                  ...
                  {entry.relations.map((rel) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex flex-col rounded-lg border border-white/5 bg-neutral-900/40 px-3 py-2"
                      >
