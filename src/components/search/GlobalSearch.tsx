...
export function GlobalSearch({
  ...
  const yearRange = useMemo(
    () => yearOptions.find((option) => option.id === selectedYearId) || null,
  ...
  const requestParams = useMemo(() => {
    ...
    if (showEpisodesFilter && minCountValue !== null)
      params.set("episodeMin", String(minCountValue));
    if (showChaptersFilter && minCountValue !== null)
      params.set("chapterMin", String(minCountValue));
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-0.5 truncate text-xs text-neutral-500">
                              ...
                              {result.subtype && result.subtype !== "movie"
                                ? ` - ${toDisplaySubtype(result.subtype)}`
                                : ""}
                            </div>
                            <div className="mt-1 flex flex-wrap items-center gap-2 text-[11px] text-neutral-400">
                              ...
                              {typeof result.chapterCount === "number" ? (
                                <span>{result.chapterCount} ch</span>
                              ) : null}
                            </div>
                          </div>
                          {selecting ? (
