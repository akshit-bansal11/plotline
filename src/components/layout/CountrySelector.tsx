                        ...
                        <div className="px-1 pb-1">
                            ...
                            {!lowerSearch && (
                                <>
                                    <div className="my-1.5 flex items-center gap-2 px-3">
                                        ...
                                        <span className="text-[9px] uppercase tracking-widest text-neutral-600">Popular</span>
                                        <div className="h-px flex-1 bg-white/5" />
                                    </div>
                                    ...
                                    <div className="my-1.5 flex items-center gap-2 px-3">
                                        <div className="h-px flex-1 bg-white/5" />
                                        <span className="text-[9px] uppercase tracking-widest text-neutral-600">All</span>
                                        <div className="h-px flex-1 bg-white/5" />
                                    </div>
                                </>
                            )}
                            ...
                            <div className="max-h-52 overflow-y-auto custom-scrollbar">
                                {filteredCountries.length === 0 ? (
                                    <div className="py-4 text-center text-xs text-neutral-500">No countries found</div>
                                ) : (
